...
type SendNotificationRequest struct {
	...
	TemplateName  string                 `protobuf:"bytes,1,opt,name=template_name,json=templateName,proto3" json:"template_name,omitempty"`                                                       //TheIDof thetemplatetobeused
	Recipient     string                 `protobuf:"bytes,2,opt,name=recipient,proto3" json:"recipient,omitempty"`                                                                                 //Therecipient'scontact(email,phonenumber,or deviceID)
	Placeholders  map[string]string      `protobuf:"bytes,3,rep,name=placeholders,proto3" json:"placeholders,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` //A map of placeholder storep lace in thetemplatebody(e.g.,{{username}}->"John")
